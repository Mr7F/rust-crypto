...
#[inline(always)]
pub fn sbox(buffer: &mut [u8]) {
    for i in 0..buffer.len() {
        buffer[i] = SBOX[buffer[i] as usize]
    }
}
...
pub const SR: [u8; 16] = [0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11];
pub const SR_INV: [u8; 16] = [0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3];
